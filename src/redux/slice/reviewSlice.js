...
export const getAllReview = createAsyncThunk("user/review/getAll", async (payload) => {
    
    return apiInstanceFetch.get(`user/review/getAll?start=${payload.start}&limit=${payload.limit}?search=${payload?.search}`)
})

export const deleteReview = createAsyncThunk("user/review/delete", async (id) => {

    return apiInstance.delete(`user/review/delete/${id}`)
})
