...
export const updateAdmin = createAsyncThunk("admin/update", async (payload) => {
  return apiInstance.patch("admin", payload);
});

export const updateAdminImage = createAsyncThunk("admin/updateImage", async (payload) => {
  return apiInstance.patch("admin/updateImage", payload);
});
