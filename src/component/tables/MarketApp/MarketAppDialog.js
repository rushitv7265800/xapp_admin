...
import { createMarketData, updateMarketApp } from "../../../redux/slice/marketAppSlice";
import { permissionError } from "../../../util/Alert";

const MarketAppDialog = () => {
  ...
  const handleImage = (e) => {
    ...
    const imgRef = ref(imageDb, `marketApp/${getRandomNumber(1, 1000)}`)
  ...
  const handleSubmit = () => {
    ...
    if (
      ...
      if (dialogueData) {
        ...
        dispatch(updateMarketApp(payload)).unwrap();
      } else {
        const data = {
          imgURL: imgUrl,
          upiID: upiID,
        ...
        dispatch(createMarketData(data)).unwrap();
      }
    }
          ...
          <div class="col-xl-4 col-md-6 col-11">
            <div class="mainDiaogBox">
              <div class="row justify-content-between align-items-center formHead">
                <div className="col-8">
                  <h2 className="text-theme m0">Marketing App</h2>
                </div>
                <div className="col-4">
                  <div
...
export default MarketAppDialog;
