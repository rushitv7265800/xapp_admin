...
import logo from "../../assets/newImage/logoNe.png";
        ...
        <div className="loginDiv" style={{ width: "100%" }}>
          <div className="loginPage m-auto">
            ...
            <div>
              ...
              <div className="loginButton w-full d-flex gx-2 justify-content-center">
                {/* <Button
                  type={`submit`}
                ...
                <Button
                  type={`submit`}
                  className={`bg-theme text-light cursor m10-top col-12 mx-2`}
                  text={`Log In`}
                  onClick={submit}
                  style={{ borderRadius: "30px" }}
                />
