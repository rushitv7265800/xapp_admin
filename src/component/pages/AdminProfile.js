...
import { getAdmin, updateAdmin, updateAdminImage, updateAdminPassword } from "../../redux/slice/authSlice";
...
export const AdminProfile = () => {
  ...
  useEffect(() => {
    setName(data?.name);
    setEmail(data?.email);
    setImagePath(baseURL + data?.image);
    setError({ name: "", email: "" });
  }, [data]);
